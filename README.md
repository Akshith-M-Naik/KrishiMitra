...
MongoDB: Install MongoDB Community Server from mongodb.com. Ensure it's running (usually on mongodb://localhost:27017).
...
git clone https://github.com/Akshith-M-Naik/SportXchange.git # Replace with your actual repo URL if different
